...
public class MD5Core {
	...
	// hash_result to store the hash value
	private static byte[] hash_result = new byte[32];
	...
	public int[] initHash(byte[] step_two_result) {
		initState();
		hashProcess(state, step_two_result);
		return state;
	}

	public int[] hashProcess(int[] state, byte[] message) {
